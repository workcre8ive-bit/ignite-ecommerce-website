      ...
      <section className="py-20 md:py-40 px-6 sm:px-12 md:px-24 flex flex-col items-center text-center relative overflow-hidden">
        ...
        >
          ...
          <button 
            ...
            className="group relative px-10 py-5 sm:px-16 sm:py-6 border-2 border-cyan-glow text-cyan-glow font-black uppercase tracking-[0.3em] sm:tracking-[0.5em] text-[10px] sm:text-xs transition-all duration-500 hover:bg-cyan-glow hover:text-midnight hover:shadow-[0_0_50px_rgba(0,243,255,0.4)] overflow-hidden"
          >
