  ...
  return (
    <div className="min-h-screen bg-midnight selection:bg-cyan-glow selection:text-midnight overflow-x-hidden font-sans">
      ...
      <main className="relative z-10">
        ...
        {/* Product Section */}
        <section className="py-24 px-8 md:px-24 bg-transparent">
          <motion.div 
            ...
            className="mb-16"
          >
            <h3 className="text-4xl font-black text-white font-display uppercase tracking-tight">Essential_Gear</h3>
            <div className="flex items-center gap-4 mt-4">
              <div className="h-[1px] w-24 bg-magenta-glow"></div>
              <p className="text-gray-500 text-xs tracking-[0.4em] uppercase font-bold">Standard_Issue // V.04</p>
            </div>
          </motion.div>
        ...
        <section className="py-40 px-8 flex flex-col items-center text-center relative overflow-hidden">
          ...
          >
            <span className="text-cyan-glow font-bold tracking-[0.4em] uppercase text-xs mb-8 block">Project // Vanguard</span>
            <h2 className="text-5xl md:text-8xl font-black text-white font-display mb-12 leading-none uppercase">
              RECODE THE <br />
              <span className="text-gradient">CITYSCAPE</span>
            </h2>
            <button className="group relative px-16 py-6 border-2 border-cyan-glow text-cyan-glow font-black uppercase tracking-[0.5em] text-xs transition-all duration-500 hover:bg-cyan-glow hover:text-midnight hover:shadow-[0_0_50px_rgba(0,243,255,0.4)] overflow-hidden">
